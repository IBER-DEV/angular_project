        ...
        <mat-card-content>
          <div class="filtros-grid">
            ...
            <mat-form-field appearance="outline">
              ...
              <mat-select [(ngModel)]="filtros.area" (ngModelChange)="aplicarFiltros()">
            ...
            <mat-form-field appearance="outline">
              ...
              <mat-select [(ngModel)]="filtros.criticidad" (ngModelChange)="aplicarFiltros()">
      ...
      <mat-card class="tabla-card" appearance="outlined">
        <mat-card-content>
          ...
          <div class="tabla-container">
            <table mat-table [dataSource]="hallazgosFiltrados$" class="hallazgos-table">
              <!-- Columna ID -->
              ...
              <ng-container matColumnDef="titulo">
                ...
                <td mat-cell *matCellDef="let hallazgo">
                  <div class="titulo-cell">
                    ...
                    <small>{{ hallazgo.descripcion | slice:0:50 }}{{ hallazgo.descripcion.length > 50 ? '...' : '' }}</small>
                  </div>
                </td>
              </ng-container>
              ...
              <ng-container matColumnDef="responsable">
                ...
                <td mat-cell *matCellDef="let hallazgo">{{ hallazgo.responsable }}</td>
              </ng-container>
              ...
              <tr mat-row *matRowDef="let row; columns: columnasDisplayed;" class="hallazgo-row"></tr>
            </table>
          </div>
        </mat-card-content>
      </mat-card>
...
export class HallazgosListaComponent implements OnInit {
  columnasDisplayed: string[] = ['titulo', 'area', 'criticidad', 'estado', 'responsable', 'fecha', 'acciones'];
  ...
  private filtrarHallazgos(hallazgos: Hallazgo[], filtros: FiltroHallazgos): Hallazgo[] {
